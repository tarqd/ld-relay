...
func (c *envContextImpl) GetUserStreamChannel(streamProvider streams.StreamProvider, credential config.SDKCredential) (update chan struct{}, heartbeat chan struct{}, close chan struct{}) {
