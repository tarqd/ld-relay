...
func NewRelayCore(
	...
	r := RelayCore{
		...
		mobileStreamProvider:          streams.NewStreamProvider(basictypes.MobilePutStream, maxConnTime),
		jsClientStreamProvider:        streams.NewStreamProvider(basictypes.JSClientPutStream, maxConnTime),
